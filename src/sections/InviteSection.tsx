...
const InviteSection = () => {
  return (
    <section className="w-full h-fit md:h-110 lg:h-200 flex flex-col sm:flex-row gap-10 overflow-visible py-20 lg:px-15">
      <div className="w-full flex flex-col justify-center items-start px-10">
        <h1 className="text-4xl lg:text-7xl bg-[var(--color-primary)] p-3 uppercase text-white rounded-lg">
          Invite
        </h1>
        <p className="py-2 lg:text-2xl">Your loved ones to church!</p>
        <h2 className="text-4xl lg:text-6xl font-bold py-2 lg:py-4">
          Sunday Service <br /> 9AM | 1PM (Youth) | 4PM
        </h2>
        <Link
          className="text-[var(--color-primary)] py-2 lg:py-4 lg:text-2xl"
