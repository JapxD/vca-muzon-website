    ...
    <section className="w-full h-fit md:h-110 xl:h-200 flex flex-col sm:flex-row gap-10 overflow-visible xl:px-15">
      <div className="w-full flex flex-col justify-center items-start px-10 py-5">
        ...
        <Link
          to="https://maps.app.goo.gl/nDP8xDbypsQCcG9w9"
          target="_blank"
          className="text-[var(--color-primary)] font-bold my-5 py-2 px-5 border border-[var(--color-primary)] rounded-lg hover:bg-[var(--color-primary)] hover:text-white transition-color duration-150"
        >
          Get Directions
        </Link>
      </div>
